...
export default function Fundream() {
  ...
  const useProjectStoreItem = useProjectStoreData.map((value) => (
    <li key={value.title}>
  ...
  return (
    <div className={style.project}>
      ...
      <a
        ...
        href="https://final-11-cutie.vercel.app/"
        target="_blank"
      >
      ...
      <div className={style.projectDesc}>
        <div className={style.projectHeader}>
          ...
          <a href="https://github.com/teakyungg/Final-11-Cutie" title="GitHub 바로가기" target="_blank">
        ...
        <div className={style.desc}>
          ...
          <div style={{ display: "flex" }}>
            ...
            <div>
              <Image
                src={"/fundream/mobile newproject.png"}
                width={580}
                height={514}
                alt="fundream mobile newproject"
              />
        ...
        <div className={style.desc}>
          ...
          <div className={style.descContent}>{`펀딩 물건을 등록하기 위한 최종 상세 설정 페이지 입니다.`}</div>

          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            {`컴포넌트 : `}
            {NewProductDetailItem}
          </div>

          <div style={{ display: "flex" }}>
            <div>
              <Image
                src={"/fundream/pc NewProductDetail.png"}
                width={580}
                height={414}
                alt="fundream pc NewProductDetail"
              />
              <div style={{ textAlign: "center", paddingTop: "10px" }}>pc 버전</div>
            </div>
            ...
            <div>
              <Image
                src={"/fundream/mobile NewProductDetail.png"}
                width={580}
                height={414}
                alt="fundream mobile NewProductDetail"
              />
              <div style={{ textAlign: "center", paddingTop: "10px" }}>mobile 버전</div>
            </div>
          </div>
