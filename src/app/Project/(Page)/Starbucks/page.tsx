  ...
  return (
    <div className={style.project}>
      ...
      <a
        ...
        href="https://startbycks-teaktung.netlify.app/"
        target="_blank"
      >
      ...
      <div className={style.projectDesc}>
        <div className={style.projectHeader}>
          ...
          <a href="https://github.com/teakyungg/Starbucks" title="GitHub 바로가기" target="_blank">
        ...
        <div className={style.desc}>
          ...
          <div className={style.descContent}>
            {`이를 해결하기 위해`}
            <Highlight>document.visibilityState</Highlight>
            {`를 감지해 
        ...
        <div className={style.desc}>
          ...
          <div style={{ display: "flex", justifyContent: "space-around" }}>
            <div>
              ...
              <div style={{ paddingTop: "20px" }}>{`현재 스크롤이 30% 이하일 때`}</div>
            </div>
            ...
            <div>
              ...
              <div style={{ paddingTop: "20px" }}>{`현재 스크롤이 30% 이상일 때`}</div>
            </div>
          </div>
        </div>
