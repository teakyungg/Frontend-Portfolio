...
export default function WonLab() {
    ...
    const fileStrItem = fileStrData.map((value) => <li style={{padding: "10px 0"}} key={value.title}><Highlight>{value.title}</Highlight> : {value.text}</li>)
    ...
    return (
        <div className={style.project}>
            ...
            href="https://teakyungg.github.io/web-1-03-scss/" target="_blank"> 
            ...
            <div className={style.projectDesc}>
                ...
                <div className={style.desc}>
                    ...
                    <div className={style.descContent}>
                    {`본 프로젝트는 index, gallery 총 두 개의 페이지로 구성되어 있으며,`}
                    </div>
