...
export default function Portfolio() {
    ...
    return (
        <div className={style.project}>
            ...
            href="https://frontend-portfolio-six-pied.vercel.app/" target="_blank"> 
            ...
            <div className={style.projectDesc}>
                ...
                <div className={style.desc}>
                    ...
                    <Image src={'/portfolio/project folder structure.png'} width={187} height={258} alt="portfolio project folder structure"/>
