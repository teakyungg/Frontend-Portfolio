    ...
    <ProjectModal closeFn={setModal}>
      <div className={styles.modalInner}>
        ...
        <div className={styles.imageInner} style={{ backgroundImage: `url(${src})` }}>
          <a href="https://teakyungg.github.io/web-1-03-scss/" target="blank" className={styles.linkInner}>
        ...
        <div className={styles.textInner}>
          ...
          <div className={styles.issueSolutionPairs}>
            ...
            <ul className={styles.questionInner}>
              <li>
                <details open>
                  <summary>SCSS 설계를 어떤 기준으로 구조화하셨나요?</summary>
              ...
              <li>
                <details open>
                  <summary>헤더·푸터처럼 공통 컴포넌트 스타일은 어떻게 재사용 가능하게 구현하셨나요?</summary>
                  <p className={styles.solution}>
              ...
              <li>
                <details open>
                  <summary>절대 위치(absolute)로 배치되는 요소들의 스타일 중복은 어떻게 줄이셨나요?</summary>
                  <p className={styles.solution}>
              ...
              <li>
                <details open>
                  <summary>고정 헤더(header: fixed) 때문에 본문 콘텐츠가 가려지는 문제는 어떻게 해결하셨나요?</summary>
                  <p className={styles.solution}>
               ...
               <li>
                <details open>
                  <summary>코드를 직접 보거나 정리한 부분을 볼 수 있을까요?</summary>
                  <p className={styles.solution}>
