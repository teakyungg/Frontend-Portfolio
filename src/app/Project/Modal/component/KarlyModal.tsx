          ...
          <div className={styles.issueSolutionPairs}>
            ...
            <ul className={styles.questionInner}>
              <li>
                <details open>
                  <summary>
                    팀 프로젝트에서 스타일 단위가 제각각이 되어 UI 일관성이 떨어질 가능성이 있었는데, 어떻게
                    해결하셨나요?
                  </summary>
              ...
              <li>
                <details open>
                  <summary>작업물을 병합하는 과정에서 발생하는 문제는 어떻게 해결하셨나요?</summary>
                  <p className={styles.solution}>
              ...
              <li>
                <details open>
                  <summary>GitHub 사용 중, 코드 변경 이력에 불필요한 차이가 발생한 문제는 어떻게 해결하셨나요?</summary>
                  <p className={styles.solution}>
