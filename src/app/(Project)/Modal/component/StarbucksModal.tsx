...
export function StarbucksModal({ setModal, src }: ModalDefaultType) {
  ...
  // 사용 기술
  const skills = ['Vite', 'Git', 'GitHub', 'GSAP', 'Swiper', '개인 프로젝트'];
    ...
    <ProjectModal closeFn={setModal}>
      <div className={styles.modalInner}>
        ...
        <div className={styles.mainImage} style={{ backgroundImage: `url(${src})` }}>
          <a href="https://startbycks-teaktung.netlify.app/" target="blank">
        ...
        <div className={styles.contentInner}>
          ...
          <div>
            ...
            <ul className={styles.qna}>
              <li>
                <details open>
                  <summary className={styles.question}>캐러셀을 직접 구현하지 않고 Swiper를 도입하신 이유가 있나요?</summary>
              ...
              <li>
                <details open>
                  <summary className={styles.question}>스크롤 위치에 따라 인터랙션을 제어할 때 어떤 접근을 하셨나요?</summary>
                  <p className={styles.solution}>
              ...
              <li>
                <details open>
                  <summary className={styles.question}>백그라운드 탭에서 캐러셀이 계속 동작해 리소스를 소모하던 문제는 어떻게 해결하셨나요?</summary>
                  <p className={styles.solution}>
              ...
              <li>
                <details open>
                  <summary className={styles.question}>접근성과 시멘틱 측면에서는 어떤 조치를 하셨나요?</summary>
                  <p className={styles.solution}>
              ...
              <li>
                <details open>
                  <summary className={styles.question}>다양한 해상도에서 배경 영상과 레이아웃 비율이 틀어지는 문제는 어떻게 대응하셨나요?</summary>
                  <p className={styles.solution}>
                    <span>
