...
export function Game2048Modal({ setModal, src }: ModalDefaultType) {
  ...
  // 사용 기술
  const skills = ['TypeScirpt', 'Git', 'GitHub', 'Prettier', 'Notion', '팀 프로젝트'];
    ...
    <ProjectModal closeFn={setModal}>
      <div className={styles.modalInner}>
        ...
        <div className={styles.mainImage} style={{ backgroundImage: `url(${src})` }}>
          <a href="https://3lines-2048.netlify.app/" target="blank">
        ...
        <div className={styles.textInner}>
          ...
          <div>
            ...
            <ul className={styles.qna}>
              <li>
                <details open>
                  <summary className={styles.question}>JavaSctipt를 사용한 프로젝트라면 타입 오류가 있었을 텐데 어떻게 대응하셨나요?</summary>
              ...
              <li>
                <details open>
                  <summary className={styles.question}>버전 관리 측면에서 어떤 방식을 적용하셨나요?</summary>
                  <p className={styles.solution}>
              ...
              <li>
                <details open>
                  <summary className={styles.question}>함수 재사용성과 개발 속도 문제는 어떻게 개선하셨나요?</summary>
                  <p className={styles.solution}>
              ...
              <li>
                <details open>
                  <summary className={styles.question}>작업 진행 상황을 체계적으로 관리하기 위해 어떤 도구를 사용하셨나요?</summary>
                  <p className={styles.solution}>
