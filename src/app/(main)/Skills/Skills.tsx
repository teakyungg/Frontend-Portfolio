    ...
    <div className={styles.skills}>
      ...
      <div className={styles.inner}>
        ...
        <ul className={styles.skillListInner}>
          <li>
            <TextStrong>React</TextStrong>로 UI를 컴포넌트 단위로 모듈화하고, <TextStrong>children</TextStrong>을 활용해
            구조적이고 재사용 가능한 페이지를 구현함.
          </li>
          <li>
          ...
          <li>
            <TextStrong>Next.js</TextStrong>로 서버 사이드 렌더링(SSR)을 적용하고, <TextStrong>SEO</TextStrong> 최적화를
            고려한 웹 페이지를 개발함.
          </li>
          <li>
            <TextStrong>Tailwind CSS</TextStrong>와 <TextStrong>SCSS</TextStrong>를 활용해 스타일링 효율과 유지보수성을
            향상시킴.
          </li>
          <li>
            <TextStrong>Swiper</TextStrong>와 <TextStrong>GSAP</TextStrong>를 활용해 슬라이드 및 애니메이션 구현 시 반복
            작업을 최소화하고, 개발 효율을 높임.
          </li>
        </ul>
      </div>
